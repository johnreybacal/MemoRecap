...
<div class="w3-top">
 	<div id="nav" class="w3-bar w3-theme-d2 w3-left-align">
    	...
    	<div id="nav" class="w3-dropdown-hover w3-hide-small w3-right">
		    <button class="w3-button" title="Scrapbooks">Scrapbooks <i class="fa fa-caret-down"></i></button>     
		    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
		      <a href="#featured" class="w3-bar-item w3-button">Featured Scrapbooks</a>
		      <a href="#recent" class="w3-bar-item w3-button">Recent Scrapbooks</a>
