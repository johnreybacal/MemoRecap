...
<div class="container bg p-4 my-4">
  ...
  <div class=" p-4 my-4" style="margin:0px 85px 0px 85px;">
	...
	<div class="pic row">
					...
					<div class="col-md-4 mb-3 mb-md-0"> <img class="card-img-top" src = "<?php echo base_url('css/images/f2.jpg'); ?>" alt=""> </div>
					<div class="col-md-4 mb-3 mb-md-0"> <img class="card-img-top" src = "<?php echo base_url('css/images/f3.jpg'); ?>" alt=""> </div>
				</div>
      <div class="card-img-overlay bg-overlay">
