...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-overlay  nav-row">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item px-lg-4">
				<a class="hed nav-link text-uppercase text-expanded landi2 " href="">About</a>
            </li>
			<li class="nav-item">
				<a class="nav-link text-expanded landi2 login" href=""><strong>Log In</strong></a>
            </li>
			</ul>
        </div>
		</div>
    ...
    <div class="container">
        ...
        <div class="text-center mt-4">
			<div class="text-heading text-lg"><p class="puter">Welcome to</p></div>
				<h1 class="hedest puter">MemoRecap</h1>
			<div class="text-heading text-lg">
				<p class="puter"><strong>Your one-stop shop of creativity.</strong></p>
			</div>
        </div>
    </div>
					...
					<div  >
	  					<div >
							<div>
				  			...
				  			<div>
								<a class="nav-link landi hed float-left EPFW" href="">Editor's Picks</a>
							</div>
				  		</div>
					</div>
			</div>
	  		...
	  		<div class="bg-faded p-4 my-4">
	  			<table >
					...
					<div  >
				  		<div >
				  			<div>
								<a class="nav-link landi hed float-left EPFW" href="">Featured Works</a>
							</div>
				  			<div>
								<a class="nav-link float-right VM landi" href="#">
									<p>View More...</p>
