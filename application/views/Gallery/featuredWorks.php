...
<!-- end of 1st -->
   ...
   <div class=" text-center">
        <ul class="pagination justify-content-center mb-0">
          <li class="page-item">
            <a class="landi hed " href="<?php echo base_url('Scrapbooks/Editors_Pick'); ?>">Editor's Pick</a>
          </li>
          <li class="page-item ">
            <a class="landi hed " href="<?php echo base_url('Scrapbooks/Latest_Works'); ?>">Recent Works</a>
          </li>
        </ul>
      </div>
