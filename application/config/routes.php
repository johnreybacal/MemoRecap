...
$route['delete/(:any)'] = 'Functions/delete/$1';
$route['save'] = 'Functions/save';
$route['create'] = 'Functions/create';
$route['Logout'] = 'Functions/Logout';
$route['loginAction'] = 'Functions/loginAction';
$route['signupAction'] = 'Functions/signupAction';
$route['Login'] = 'MemoRecap/Login';
